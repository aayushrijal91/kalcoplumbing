        ...
        <div class="container position-relative">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 py-5 order-1 order-lg-2">
                    <p class="text-primary fw-700 fs-70 lh-1">Duis Rutrum Tortor Nec Nisi Hendrerit Pellentesque</p>

                    <article class="description lh-1_67 text-dark fw-500 py-4">
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer tempor mi at tellus iaculis condimentum. Sed ante purus, bibendum nec libero et, consectetur lobortis nibh. Donec non quam orci. Vivamus pellentesque magna tortor, a convallis mi rhoncus at. In mattis id libero vitae mollis.
                        </p>

                        <p>
                            Fusce feugiat odio nibh, tincidunt dictum mauris cursus in. Duis rutrum tortor nec nisi hendrerit pellentesque. Sed commodo, justo non dignissim eleifend, justo lacus vehicula nibh, et fermentum dui lacus ac quam
                        </p>
                    </article>
            ...
            <div class="row gy-4">
                <div class="col-xl-6">
                    <div class="ctaCard h-100">
                        ...
                        <p class="fs-70 fw-700 lh-1 position-relative">Aliquam Eleifend Vestibulum Nibh, At Aliquam</p>

                        <article class="description lh-1_67 pt-4 py-md-5 text-lighter position-relative">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer tempor mi at tellus iaculis condimentum. Sed ante purus, bibendum nec libero et, consectetur lobortis nibh. Donec non quam orci. Vivamus pellentesque magna tortor, a convallis mi rhoncus at. In mattis id libero vitae mollis.</p>

                            <p>Fusce feugiat odio nibh, tincidunt dictum mauris cursus in. Duis rutrum tortor nec nisi hendrerit pellentesque. Sed commodo, justo non dignissim eleifend</p>
                        </article>
        ...
        <section class="bg-primary rounded-40 px-4 position-relative mt-7">
            ...
            <div class="row align-items-end position-relative">
                ...
                <div class="col-xl-6 py-5 order-1 order-xl-2">
                    <p class="text-white fs-54 fw-700 text-capitalize lh-0_9 text-center text-xl-start">Duis rutrum tortor nec nisi hendrerit pellentesque</p>

                    <article class="lh-1_67 description pt-4 text-center text-xl-start">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer tempor mi at tellus iaculis condimentum. Sed ante purus, bibendum nec libero et, consectetur lobortis nibh. Donec non quam orci. Vivamus pellentesque magna tortor, a convallis mi rhoncus at. In mattis id libero vitae mollis.</p>
                        <p>Fusce feugiat odio nibh, tincidunt dictum mauris cursus in. Duis rutrum tortor nec nisi hendrerit pellentesque. Sed commodo, justo non dignissim eleifend, justo lacus vehicula nibh, et fermentum dui lacus ac quam</p>
                    </article>
