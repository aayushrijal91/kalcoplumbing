...
<main class="blogPost">
    <div class="container py-6 py-lg-7">
        <?php if (!empty(get_field('introduction')['hero_image'])) : ?>
            <div class="introduction_image" style="height: 300px">
                <img class="h-100 w-100 object-fit-cover object-position-top" src="<?= get_field('introduction')['hero_image']['url'] ?>" alt="">
            </div>
        <?php else : ?>
            <div class="bg-light py-7 d-flex justify-content-center align-items-center">
        ...
        <?php if (!empty(get_field('introduction')['title']) && !empty(get_field('introduction')['description'])) : ?>
            <div class="bg-lighter py-5 px-3 p-md-5">
                <p class="fs-48 fw-700 col-xl-6 lh-1 highlight-primary text-light-grey"><?= get_field('introduction')['title'] ?></p>

                <article class="fs-20 pt-4 pt-md-5 lh-1_67 description column-count-2">
                    <?= get_field('introduction')['description'] ?>
                </article>
            </div>
        <?php endif; ?>
    </div>
    ...
    ?>
        <section class="bg-lighter py-5 py-md-9">
            <div class="container">
                <div class="row gx-xl-7">
                    <div class="col-12 col-md-6">
                        <p class="fs-48 fw-700 lh-1 highlight-primary text-light-grey"><?= $about['title'] ?></p>

                        <?php if (!empty($about['description'])) : ?>
                            <article class="fs-20 pt-5 lh-1_67 description">
                                <?= $about['description'] ?>
                            </article>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <?php else : ?>
                            <div class="bg-light py-7 d-flex justify-content-center align-items-center h-100">
                                <svg width="114" height="114" viewBox="0 0 114 114" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M95.0295 0.355713H19.4684C14.4584 0.355713 9.65357 2.34593 6.11096 5.88855C2.56834 9.43116 0.578125 14.236 0.578125 19.246L0.578125 94.8071C0.578125 99.8171 2.56834 104.622 6.11096 108.165C9.65357 111.707 14.4584 113.697 19.4684 113.697H95.0295C100.039 113.697 104.844 111.707 108.387 108.165C111.93 104.622 113.92 99.8171 113.92 94.8071V19.246C113.92 14.236 111.93 9.43116 108.387 5.88855C104.844 2.34593 100.039 0.355713 95.0295 0.355713ZM38.3587 19.246C40.2267 19.246 42.0529 19.7999 43.6061 20.8378C45.1593 21.8756 46.37 23.3507 47.0848 25.0766C47.7997 26.8025 47.9868 28.7016 47.6223 30.5338C47.2579 32.366 46.3583 34.0489 45.0374 35.3698C43.7165 36.6908 42.0335 37.5903 40.2013 37.9548C38.3691 38.3192 36.47 38.1322 34.7442 37.4173C33.0183 36.7024 31.5432 35.4918 30.5053 33.9386C29.4675 32.3853 28.9135 30.5592 28.9135 28.6911C28.9135 26.1861 29.9086 23.7837 31.6799 22.0124C33.4513 20.2411 35.8537 19.246 38.3587 19.246ZM91.5442 85.3619H25.9855C25.5004 85.3617 25.0272 85.2121 24.6301 84.9334C24.233 84.6547 23.9314 84.2605 23.7663 83.8044C23.6012 83.3482 23.5806 82.8523 23.7073 82.384C23.8339 81.9158 24.1018 81.4979 24.4743 81.1872L73.6457 40.2142C73.9325 39.9761 74.2715 39.8093 74.6351 39.7274C74.9987 39.6455 75.3765 39.6509 75.7376 39.743C76.0987 39.8351 76.4329 40.0114 76.7129 40.2575C76.9928 40.5035 77.2105 40.8124 77.3482 41.1587L93.7355 82.1223C93.8791 82.4805 93.9327 82.8685 93.8915 83.2523C93.8504 83.6361 93.7158 84.0039 93.4996 84.3236C93.2833 84.6433 92.992 84.9051 92.6511 85.0861C92.3102 85.2671 91.9302 85.3618 91.5442 85.3619Z" fill="white" />
                                </svg>
                            </div>
    ...
    <?php $enquiry = get_field('enquiry'); ?>

    <?php if (!empty($enquiry['hero_image'])) : ?>
        <div class="introduction_image" style="height: 434px">
            <img class="h-100 w-100 object-fit-cover object-position-top" src="<?= $enquiry['hero_image']['url'] ?>" alt="<?= $enquiry['hero_image']['alt'] ?>">
        </div>
    <?php else : ?>
        <div class="bg-primary py-10 d-flex justify-content-center align-items-center">
            <svg width="114" height="114" viewBox="0 0 114 114" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M95.0295 0.355713H19.4684C14.4584 0.355713 9.65357 2.34593 6.11096 5.88855C2.56834 9.43116 0.578125 14.236 0.578125 19.246L0.578125 94.8071C0.578125 99.8171 2.56834 104.622 6.11096 108.165C9.65357 111.707 14.4584 113.697 19.4684 113.697H95.0295C100.039 113.697 104.844 111.707 108.387 108.165C111.93 104.622 113.92 99.8171 113.92 94.8071V19.246C113.92 14.236 111.93 9.43116 108.387 5.88855C104.844 2.34593 100.039 0.355713 95.0295 0.355713ZM38.3587 19.246C40.2267 19.246 42.0529 19.7999 43.6061 20.8378C45.1593 21.8756 46.37 23.3507 47.0848 25.0766C47.7997 26.8025 47.9868 28.7016 47.6223 30.5338C47.2579 32.366 46.3583 34.0489 45.0374 35.3698C43.7165 36.6908 42.0335 37.5903 40.2013 37.9548C38.3691 38.3192 36.47 38.1322 34.7442 37.4173C33.0183 36.7024 31.5432 35.4918 30.5053 33.9386C29.4675 32.3853 28.9135 30.5592 28.9135 28.6911C28.9135 26.1861 29.9086 23.7837 31.6799 22.0124C33.4513 20.2411 35.8537 19.246 38.3587 19.246ZM91.5442 85.3619H25.9855C25.5004 85.3617 25.0272 85.2121 24.6301 84.9334C24.233 84.6547 23.9314 84.2605 23.7663 83.8044C23.6012 83.3482 23.5806 82.8523 23.7073 82.384C23.8339 81.9158 24.1018 81.4979 24.4743 81.1872L73.6457 40.2142C73.9325 39.9761 74.2715 39.8093 74.6351 39.7274C74.9987 39.6455 75.3765 39.6509 75.7376 39.743C76.0987 39.8351 76.4329 40.0114 76.7129 40.2575C76.9928 40.5035 77.2105 40.8124 77.3482 41.1587L93.7355 82.1223C93.8791 82.4805 93.9327 82.8685 93.8915 83.2523C93.8504 83.6361 93.7158 84.0039 93.4996 84.3236C93.2833 84.6433 92.992 84.9051 92.6511 85.0861C92.3102 85.2671 91.9302 85.3618 91.5442 85.3619Z" fill="white" />
            </svg>
        </div>
    ...
    <?php if (!empty($enquiry['title'])) : ?>
        <div class="container py-6 py-lg-7">
            <?php if (!empty($enquiry['image'])) : ?>
                <div class="introduction_image" style="height: 300px">
                    <img class="h-100 w-100 object-fit-cover object-position-top" src="<?= $enquiry['image']['url'] ?>" alt="<?= $enquiry['image']['alt'] ?>">
                </div>
            <?php else : ?>
                <div class="bg-light py-7 d-flex justify-content-center align-items-center">
                    <svg width="114" height="114" viewBox="0 0 114 114" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-lighter px-3 py-5 p-md-5">
                <div class="row gy-4 justify-content-between align-items-center">
                    <p class="fs-48 fw-700 col-xl-6 lh-1 highlight-primary text-light-grey"><?= $enquiry['title'] ?></p>
